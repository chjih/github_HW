...
1. [로컬 파일 생성, 기본 설정](#로컬-파일-생성)
2. [git 설정](#git-설정)
3. [Github 연동](#Github-연동)
4. [Github에 소스코드 올리기](#Github에-소스코드-올리기)
5. [브랜치 생성 후 원격 저장소에 저장](#브랜치-생성-후-원격-저장소에-저장)
6. [이전으로 커밋으로 돌아가기](#이전-커밋으로-돌아가기 )
7. [두 branch 합치기](#7.-두-branch-합치기)
8. [로그 한줄로 나타내기](#로그-한줄로-나타내기)
9. [Github의 소스 내려받기](#Github의-소스-내려받기)
10. [변경된 소스코드 내려받기](#변경된-소스코드-내려받기)
11. [태그 달고 원격저장소에 올리기](#태그-달고-원격저장소에-올리기)
12. [표](#표)
...
| 명령어 | 사용 여부|
|---|:---:|
|add [(1)](#Github에-소스코드-올리기)|o|
|branch [(1)](#브랜치-생성-후-원격-저장소에-저장) [(2)](#이전-커밋으로-돌아가기)|o|
|checkout [(1)](#이전-커밋으로-돌아가기)|o|
|clone [(1)](#Github의-소스-내려받기)|o|
|commit [(1)](#Github에-소스코드-올리기)|o|
|config [(1)](#git-설정)|o|
|init [(1)](#로컬-파일-생성)|o|
|log [(1)](#Github에-소스코드-올리기) [(2)](#두-branch-합치기) [(3)](#로그-한줄로-나타내기)|o|
|merge [(1)](#두-branch-합치기)|o|
|pull [(1)](#변경된-소스코드-내려받기)|o|
|push [(1)](#Github에-소스코드-올리기) [(2)](#브랜치-생성-후-원격-저장소에-저장)|o|
|rebase [(1)](#로그-한줄로-나타내기)|o||
|remote [(1)](#Github-연동)|o|
|reset--hard [(1)](#이전-커밋으로-돌아가기)|o|
|status [(1)](#Github에-소스코드-올리기)|o|테스트3|
|tag [(1)](#태그-달고-원격저장소에-올리기)|o|
